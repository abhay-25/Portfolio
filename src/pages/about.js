...
import profilePic from "../../public/images/profile/abhay-removebg-preview.jpg";
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I am Abhay, a full stack web developer with a
                passion for creating beautiful, functional, and user-centered
                digital experiences. I am just a beginner in the field. I
              ...
              <p className="font-medium">
                Whenever, I am working on a website, I bring my commitment to design excellence and
