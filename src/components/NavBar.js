...
export const NavBar = () => {
  ...
  return (
    ...
    items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8"
    >
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          <motion.a
            href="https://twitter.com/Abhaynimje25"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mr-3"
          ...
          <a
            href="https://github.com/abhay-25"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <a
            href="https://www.linkedin.com/in/abhay-nimje-54a72a229/"
            target={"_blank"}
            className="w-6 mx-3"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
